...
//}, POLLING_INTERVAL);
//};
//function isSamplePurchase() {
//const ecommerceData = window.dataLayer.filter((item) => {
//return item.ecommerce;
//})[0];
//if (ecommerceData && ecommerceData.ecommerce && ecommerceData.ecommerce.purchase) {
//const { products } = ecommerceData.ecommerce.purchase;
//const hasFreeSample = products.some((product) => {
//return product.category.indexOf('Free Samples') !== -1;
//});
//return hasFreeSample;
//}
//return false;
//}
//pollerLite(['.checkout-onepage-success'], () => {
//setTimeout(() => {
//const isSample = isSamplePurchase();
//console.log(isSample);
//if (
//isSample &&
//window.location.href.includes('/checkout/onepage/success') &&
//!sessionStorage.getItem('samplePurchase')
//) {
//console.log('it worked');
//window._conv_q = window._conv_q || [];
//window._conv_q.push(['triggerConversion', '10049145']);
//sessionStorage.setItem('samplePurchase', true);
//} else {
//console.log('conditions did not meet');
//}
//}, 1000);
//});
//})();
