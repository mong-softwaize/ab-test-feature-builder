export const productCard = ({ id, prodId, img, title, price, color, comparePrice, url }, ID) => {
  const html = `
    <div class="swiper-slide horizontal-product rounded-xs snap-start bg-custom" style="--background: 242 242 242">
    <img
      src="${img}"
      alt="${title}"
      width="2500"
